                ...
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <?php
                                    ...
                                    ?>
                            <a href="index.php"><span class="badge badge-success pull-right"><?php echo $percent;?></span> Special Notices</a>
                        </li>
                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
                                        ...
                                        <li class="active">Special Notices</li>
                   ...
                   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">List of Notices</div>
